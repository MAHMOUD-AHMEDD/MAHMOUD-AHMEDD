...
[![Email](https://img.shields.io/badge/Email-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:ma6652@fayoum.edu.eg)
[![Profile Views](https://komarev.com/ghpvc/?username=MAHMOUD-AHMEDD&style=for-the-badge&color=6E57F7&label=PROFILE+VIEWS)](https://github.com/MAHMOUD-AHMEDD)
...
I started with **PHP/Laravel**, building real multi-role systems — e-commerce, university platforms, REST APIs. Then I moved to **.NET** because I wanted to think in systems, not just endpoints. Clean Architecture. Domain modeling. Patterns that survive production.

That curiosity led me deeper: *where does this actually run?* So I dove into **AWS**, Docker, ECS Fargate — and learned to see the whole picture, from the first `dotnet new` to a highly available deployment in the cloud.
